...
**Warning:** Usage of multiple URI bindings is considered an **anti-pattern**.
All other alternatives **should** be considered before resorting to using the
multiple URI binding mechanism.
